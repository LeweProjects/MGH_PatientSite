      ...
      <div className="flex flex-col py-[80px] pb-6 items-center">
        ...
        <div className="find bg-white  flex flex-col p-14 pb-12 mb-10"  data-aos="zoom-up" data-aos-duration="800">
          <div className="flex flex-col items-center space-y-8">
            <table>
              <thead data-aos="fade-up" data-aos-anchor-placement="top-center">
              <tr>
              ...
              <tbody data-aos="fade-up" data-aos-anchor-placement="top-center">
              <tr>
                <td>
                  <input
                    type="text"
            ...
            <button data-aos="fade-up" data-aos-anchor-placement="top-center" className="bg-[#418D3F] ring-[#418D3F] w-1/2 py-1 font-semibold text-2xl text-white rounded-md transition duration-10 ease-in-out hover:bg-[#A5DD9D] hover:text-[#267124]  hover:ring-[3px]">
              SEARCH
            </button>
          </div>
        </div>
